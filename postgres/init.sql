...
CREATE TABLE IF NOT EXISTS pratica (
    ...
    CONSTRAINT fk_user_pratica FOREIGN KEY (user_id) REFERENCES user(uid) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS documento (
    ...
    CONSTRAINT fk_user_document FOREIGN KEY (user_id) REFERENCES user(uid) ON DELETE CASCADE
);
